...
public interface ICraftItems extends ICraft, IProvideItems, IItemSpaceControl, IRequireReliableTransport {
    ...
    /**
     * some items do not have a specific list of things they can craft (ie, AE crafting system, fuzzy crafting) in this
     * case enumerating them all will be slow/impossible.
     *
