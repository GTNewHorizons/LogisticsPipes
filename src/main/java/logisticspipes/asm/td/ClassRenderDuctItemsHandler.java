...
public class ClassRenderDuctItemsHandler {
    ...
    public static byte[] handleRenderDuctItemsClass(byte[] bytes) {
        ...
        final String sumHandleEvent = ASMHelper.getCheckSumForMethod(
                reader,
                "renderTravelingItems",
                "(Ljava/util/Iterator;Lcofh/thermaldynamics/duct/item/TileItemDuct;Lnet/minecraft/world/World;DDDF)V");
        if (!"200CEA4577399EED0689ED20BE6B4D065E1B2E29".equals(sumHandleEvent)
                && !"2AA29BD8490065CAEB36AE72C3BFD99054DED33E".equals(sumHandleEvent)) {
        ...
        for (MethodNode m : node.methods) {
            if (m.name.equals("renderTravelingItems")
                    && m.desc.equals(
                            "(Ljava/util/Iterator;Lcofh/thermaldynamics/duct/item/TileItemDuct;Lnet/minecraft/world/World;DDDF)V")) {
                MethodNode mv =
                        new MethodNode(
                            ...
                            public void visitMethodInsn(
                                ...
                                if (owner.equals("org/lwjgl/opengl/GL11")
                                    ...
                                    this.visitMethodInsn(
                                            ...
                                            "renderItemTransportBox",
                                            "(Lcofh/thermaldynamics/duct/item/TravelingItem;)V",
                                            false);
                                }
                            }
                        };
