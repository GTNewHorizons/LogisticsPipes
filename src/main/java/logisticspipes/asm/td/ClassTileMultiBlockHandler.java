...
public class ClassTileMultiBlockHandler {
    ...
    public static byte[] handleTileMultiBlockClass(byte[] bytes) {
        ...
        String sumHandleEvent1 = ASMHelper.getCheckSumForMethod(
                reader, "getAdjTileEntitySafe", "(I)Lnet/minecraft/tileentity/TileEntity;");
        String sumHandleEvent2 = ASMHelper.getCheckSumForMethod(
                reader, "getConnectedSide", "(B)Lcofh/thermaldynamics/multiblock/IMultiBlock;");
        if (!"A77B2F423A03F5546E6B9C8CE5090F830BAE6295".equals(sumHandleEvent1)
                ...
                && !"201FC2B21D5B2ED1F560EB23FE9AE4F4F86BE8E4".equals(sumHandleEvent1)) {
                            ...
                            public void visitInsn(int opcode) {
                                if (opcode == Opcodes.ARETURN) {
                                    ...
                                    this.visitMethodInsn(
                                            ...
                                            "checkGetTileEntity",
                                            "(Lnet/minecraft/tileentity/TileEntity;ILcofh/thermaldynamics/block/TileTDBase;)Lnet/minecraft/tileentity/TileEntity;",
                                            false);
                                }
