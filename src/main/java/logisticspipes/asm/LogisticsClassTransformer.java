...
public class LogisticsClassTransformer implements IClassTransformer {
    ...
    private byte[] handleTileEntityClass(byte[] bytes) {
        ...
        node.visitField(
                Opcodes.ACC_PRIVATE,
                "informationObjectLogisticsPipes",
    ...
    private byte[] addAddInfoPart(byte[] bytes, String className) {
        ...
        {
            FieldVisitor fv = node.visitField(
                    Opcodes.ACC_PRIVATE,
                    "logisticsPipesAdditionalInformation",
                    "Ljava/util/ArrayList;",
                    "Ljava/util/ArrayList<Llogisticspipes/asm/addinfo/IAddInfo;>;",
                    null);
            fv.visitEnd();
        }
        ...
        MethodVisitor mv;
        {
            mv = node.visitMethod(
                    Opcodes.ACC_PUBLIC,
                    "getLogisticsPipesAddInfo",
                    "(Ljava/lang/Class;)Llogisticspipes/asm/addinfo/IAddInfo;",
                    "<T::Llogisticspipes/asm/addinfo/IAddInfo;>(Ljava/lang/Class<TT;>;)TT;",
                    null);
            mv.visitCode();
            Label l0 = new Label();
            mv.visitLabel(l0);
        ...
        }
        {
            mv = node.visitMethod(
                    Opcodes.ACC_PUBLIC,
                    "setLogisticsPipesAddInfo",
                    "(Llogisticspipes/asm/addinfo/IAddInfo;)V",
                    null,
                    null);
            mv.visitCode();
            Label l0 = new Label();
