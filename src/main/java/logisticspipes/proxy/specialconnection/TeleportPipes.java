...
public class TeleportPipes implements ISpecialPipedConnection {
    ...
    public boolean init() {
        try {
            ...
            TeleportPipes.teleportPipeMethod = TeleportPipes.PipeItemTeleport
                    .getMethod("getConnectedPipes", boolean.class);
    ...
    @Override
    public List<ConnectionInformation> getConnections(IPipeInformationProvider tile,
                    ...
                    list.add(
                            new ConnectionInformation(
                                    SimpleServiceLocator.pipeInformationManager
                                            .getInformationProviderFor(pipe.container),
                                    connection,
                                    side,
