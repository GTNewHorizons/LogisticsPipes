    ...
    public void addCraftingRecipes(ICraftingParts parts) {
        if (!Configs.ENABLE_BETA_RECIPES) {
            Recipes.advRecipes.addRecipe(
                    new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.ELECTRICBUFFER), "CGC",
				"rBr",
				"CrC",
				'C',
            ...
            Recipes.advRecipes.addRecipe(
                    new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.ELECTRICBUFFER), " G ",
				"rBr",
				"CrC",
				'C',
				IC2Items.getItem("advancedCircuit"),
            ...
            Recipes.advRecipes.addRecipe(
                    new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.ELECTRICMANAGER), "CGD",
				"rBr",
				"DrC",
				'C',
            ...
            Recipes.advRecipes.addRecipe(
                    new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.ELECTRICMANAGER), "CGc",
				"rBr",
				"DrC",
				'C',
				IC2Items.getItem("electronicCircuit"),
            ...
            Recipes.advRecipes.addRecipe(
                    new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.ELECTRICMANAGER), " G ",
				"rBr",
				"DrC",
				'C',
				IC2Items.getItem("electronicCircuit"),
            ...
            Recipes.advRecipes.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, ItemUpgrade.POWER_IC2_LV_SUPPLIER), "PSP",
				"OBO",
				"PTP",
				'B',
            ...
            Recipes.advRecipes.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, ItemUpgrade.POWER_IC2_MV_SUPPLIER), "PSP",
				"OBO",
				"PTP",
				'B',
            ...
            Recipes.advRecipes.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, ItemUpgrade.POWER_IC2_HV_SUPPLIER), "PSP",
				"OBO",
				"PTP",
				'B',
            ...
            Recipes.advRecipes.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, ItemUpgrade.POWER_IC2_EV_SUPPLIER), "PSP",
				"OBO",
				"PTP",
				'B',
