...
public class ProxyManager {
    public static <T> T getWrappedProxy(
            String modId, Class<T> interfaze, Class<? extends T> proxyClazz, T dummyProxy, Class<?>... object) {
        try {
    ...
    public static void load() {
        SimpleServiceLocator.setBuildCraftProxy(ProxyManager.getWrappedProxy(
                "BuildCraft|Transport+BuildCraft|Silicon+BuildCraft|Robotics",
                IBCProxy.class,
                BuildCraftProxy.class,
                new IBCProxy() {
                    @Override
                    ...
                    @Override
                    public boolean checkForPipeConnection(
                            TileEntity with, ForgeDirection side, LogisticsTileGenericPipe pipe) {
                        return true;
                    }

                    @Override
                    public IConnectionOverrideResult checkConnectionOverride(
                            TileEntity with, ForgeDirection side, LogisticsTileGenericPipe pipe) {
                    ...
                    public void notifyOfChange(
                            LogisticsTileGenericPipe logisticsTileGenericPipe, TileEntity tile, ForgeDirection o) {}
                        ...
                        return new IBCTilePart() {
                            ...
                            public IBCRenderState getBCRenderState() {
                                return new IBCRenderState() {
                                    ...
                                    @Override
                                    public void readData_LP(LPDataInputStream data) {}
                    ...
                    @Override
                    public IBCClickResult handleBCClickOnPipe(
                            World world,
                            int x,
                            int y,
                            int z,
                ...
                IBCTilePart.class,
                IBCPipePart.class,
                IBCPipePluggable.class,
                IBCPluggableState.class,
                IBCRenderState.class,
                IBCRenderTESR.class));

        SimpleServiceLocator.setForestryProxy(ProxyManager.getWrappedProxy(
                "Forestry", IForestryProxy.class, ForestryProxy.class, new IForestryProxy() {
                    @Override
        ...
        SimpleServiceLocator.setCCProxy(ProxyManager.getWrappedProxy(
                LPConstants.computerCraftModID, ICCProxy.class, CCProxy.class, new ICCProxy() {
                    ...
                    public void queueEvent(
                            String event, Object[] arguments, LogisticsTileGenericPipe logisticsTileGenericPipe) {}
        ...
        SimpleServiceLocator.setThaumCraftProxy(ProxyManager.getWrappedProxy(
                "Thaumcraft", IThaumCraftProxy.class, ThaumCraftProxy.class, new IThaumCraftProxy() {
                    @Override
                    ...
                    @Override
                    @SideOnly(Side.CLIENT)
                    public void renderAspectsInGrid(
        ...
        SimpleServiceLocator.setThermalExpansionProxy(ProxyManager.getWrappedProxy(
                "ThermalExpansion",
                IThermalExpansionProxy.class,
                ThermalExpansionProxy.class,
                new IThermalExpansionProxy() {
                    @Override
        ...
        SimpleServiceLocator.setBetterStorageProxy(ProxyManager.getWrappedProxy(
                "betterstorage",
                IBetterStorageProxy.class,
                BetterStorageProxy.class,
                new IBetterStorageProxy() {
                    @Override
        ...
        SimpleServiceLocator.setNEIProxy(
                ProxyManager.getWrappedProxy("NotEnoughItems", INEIProxy.class, NEIProxy.class, new INEIProxy() {
                    @Override
                    ...
                    public boolean renderItemToolTip(
                            int posX, int posY, List<String> msg, EnumChatFormatting rarityColor, ItemStack stack) {
                        return false;
                    }
                    ...
                    @Override
                    public ItemStack getItemForPosition(
                            World world, EntityPlayer player, MovingObjectPosition objectMouseOver) {
                        return null;
                    }
                }));
        ...
        SimpleServiceLocator.setIronChestProxy(ProxyManager.getWrappedProxy(
                "IronChest", IIronChestProxy.class, IronChestProxy.class, new IIronChestProxy() {
                    @Override
        ...
        SimpleServiceLocator.setEnderStorageProxy(ProxyManager.getWrappedProxy(
                "EnderStorage", IEnderStorageProxy.class, EnderStorageProxy.class, new IEnderStorageProxy() {
                    @Override
        ...
        SimpleServiceLocator.setOpenComputersProxy(ProxyManager.getWrappedProxy(
                LPConstants.openComputersModID,
                IOpenComputersProxy.class,
                OpenComputersProxy.class,
                new IOpenComputersProxy() {
                    @Override
        ...
        SimpleServiceLocator.setToolWrenchProxy(ProxyManager.getWrappedProxy(
                "!IToolWrench", IToolWrenchProxy.class, ToolWrenchProxy.class, new IToolWrenchProxy() {
                    @Override
        ...
        SimpleServiceLocator.setCoFHPowerProxy(ProxyManager.getWrappedProxy(
                "CoFHAPI|energy",
                ICoFHPowerProxy.class,
                CoFHPowerProxy.class,
                new ICoFHPowerProxy() {
                    @Override
        ...
        Class<?>[] cclSubWrapper = new Class<?>[] {
            IIconTransformation.class,
            IRenderState.class,
            IModel3D.class,
            ITranslation.class,
            IVec3.class,
