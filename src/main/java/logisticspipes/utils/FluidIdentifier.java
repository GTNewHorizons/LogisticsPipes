...
public class FluidIdentifier implements ILPCCTypeHolder {
    ...
    private static final Lock rlock = FluidIdentifier.dblock.readLock();
    ...
    private static final ArrayList<HashMap<FinalNBTTagCompound, FluidIdentifier>> _fluidIdentifierTagCache = new ArrayList<>(
            256);
    ...
    public static FluidIdentifier get(Fluid fluid, NBTTagCompound tag, FluidIdentifier proposal) {
        ...
        if (tag == null) {
            ...
            FluidIdentifier unknownFluid = new FluidIdentifier(
                    fluidID,
