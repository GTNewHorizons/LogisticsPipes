...
public class ModuleCrafterMK3 extends ModuleCrafter
    ...
    protected int spaceFor(ItemIdentifier item, boolean includeInTransit, boolean addBufferSpace) {
        Triplet<String, ItemIdentifier, Boolean> key =
                new Triplet<String, ItemIdentifier, Boolean>("spaceForMK3", item, addBufferSpace);
        ...
        for (AdjacentTile tile : crafters) {
            for (int i = inv.getSizeInventory() - 1; i >= 0; i--) {
                ...
                if (_service.getItemOrderManager().hasOrders(ResourceType.CRAFTING)) {
                    ...
                    ItemStack added = InventoryHelper.getTransactorFor(tile.tile, tile.orientation.getOpposite())
                    ...
                    _service.queueRoutedItem(
                            SimpleServiceLocator.routedItemHelper.createNewTravelItem(toadd),
