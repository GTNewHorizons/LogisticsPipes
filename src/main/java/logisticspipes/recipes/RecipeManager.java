    ...
    public static void loadRecipes(ICraftingParts parts) {
        ...
        if (!Configs.ENABLE_BETA_RECIPES) {
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.BasicTransportPipe, 8), CraftingDependency.Basic, new Object[] {
                        "IgI",
                        " r ",
                        Character.valueOf('g'),
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.LogisticsBasicPipe, 8), CraftingDependency.Basic, new Object[] {
                        "grg",
                        "cdc",
                        " G ",
                        Character.valueOf('G'),
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.LogisticsProviderPipeMk1, 1), CraftingDependency.Basic, new Object[] {
                        " G ",
                        "rPr",
                        Character.valueOf('P'),
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.LogisticsCraftingPipeMk1, 1), CraftingDependency.Basic, new Object[] {
                        "r",
                        "P",
                        "S",
                        Character.valueOf('P'),
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.LogisticsRequestPipeMk1, 1), CraftingDependency.Basic, new Object[] {
                        "g",
                        "P",
                        "i",
                        Character.valueOf('P'),
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.LogisticsItemDisk, 1), CraftingDependency.Fast_Crafting, new Object[] {
                        "igi",
                        "grg",
                        "igi",
                        Character.valueOf('i'),
            ...
            RecipeManager.craftingManager.addShapelessRecipe(
                    ...
                    CraftingDependency.Modular_Pipes,
                    new Object[] {new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.CRAFTER), parts.getGearTear2()
                    });

            RecipeManager.craftingManager.addShapelessRecipe(
                    new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.CRAFTER_MK2),
                    CraftingDependency.Modular_Pipes,
                    new Object[] {new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.CRAFTER), parts.getChipTear2()
                    });
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.LogisticsSolidBlock, 1, 0), CraftingDependency.Basic, new Object[] {
                        "iCi",
                        "i i",
                        "iri",
                        Character.valueOf('C'),
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.LogisticsSolidBlock, 1, 1), CraftingDependency.Basic, new Object[] {
                        "iii",
                        "rRr",
                        "iii",
                        Character.valueOf('R'),
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.LogisticsSolidBlock, 1, 2), CraftingDependency.Security, new Object[] {
                        "iDi",
                        "rBr",
                        "iii",
                        Character.valueOf('D'),
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.LogisticsSolidBlock, 1, 3), CraftingDependency.Basic, new Object[] {
                        "wCw",
                        " G ",
                        "wSw",
                        Character.valueOf('w'),
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 0), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "srs",
                        "rCr",
                        "PrP",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 1), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "PrP",
                        "rCr",
                        "srs",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 2), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "PsP",
                        "rCr",
                        "PrP",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 3), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "PrP",
                        "rCr",
                        "PsP",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 4), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "PrP",
                        "sCr",
                        "PrP",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 5), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "PrP",
                        "rCs",
                        "PrP",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 6), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "PrP",
                        "rCr",
                        "PrP",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 20), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "PrP",
                        "rCr",
                        "PrP",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 21), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "PrP",
                        "rCr",
                        "PrP",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 22), CraftingDependency.Active_Liquid, new Object[] {
                        false,
                        "RbR",
                        "bCb",
                        "RbR",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 23), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "RgR",
                        "gCg",
                        "RgR",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 10), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "srs",
                        "rCr",
                        "PrP",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 11), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "PrP",
                        "rCr",
                        "srs",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 12), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "PsP",
                        "rCr",
                        "PrP",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 13), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "PrP",
                        "rCr",
                        "PsP",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 14), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "PrP",
                        "sCr",
                        "PrP",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 15), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "PrP",
                        "rCs",
                        "PrP",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 24), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "Rhy",
                        "iCi",
                        "riR",
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.UpgradeItem, 1, 25), CraftingDependency.Upgrades, new Object[] {
                        false,
                        "PrP",
                        "rCr",
                        "PrP",
        ...
        if (Configs.ENABLE_BETA_RECIPES) {
            ...
            RecipeManager.craftingManager.addRecipe(
                    ...
                    CraftingDependency.Basic,
                    new Object[] {"I I", "   ", "I I", Character.valueOf('I'), Items.iron_ingot});
            ...
            RecipeManager.craftingManager.addRecipe(
                    ...
                    CraftingDependency.Basic,
                    new Object[] {" g ", "ggg", " g ", Character.valueOf('g'), Blocks.glass});
            ...
            RecipeManager.craftingManager.addRecipe(
                    ...
                    CraftingDependency.Basic,
                    new Object[] {"ppp", "plp", "ppp", Character.valueOf('l'), logproc, Character.valueOf('p'), basic});
            ...
            RecipeManager.craftingManager.addShapelessRecipe(
                    new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.ACTIVE_SUPPLIER),
                    CraftingDependency.Modular_Pipes,
                    new Object[] {new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.PASSIVE_SUPPLIER), expand});
            ...
            RecipeManager.craftingManager.addShapelessRecipe(
                    new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.CRAFTER_MK2),
                    CraftingDependency.Modular_Pipes,
                    new Object[] {new ItemStack(LogisticsPipes.ModuleItem, 1, ItemModule.CRAFTER), expand});
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.LogisticsChassisPipeMk2, 1),
                    CraftingDependency.Modular_Pipes,
                    new Object[] {"iii", "iPi", Character.valueOf('P'), pipe, Character.valueOf('i'), Items.iron_ingot
                    });
            ...
            RecipeManager.craftingManager.addRecipe(
                    new ItemStack(LogisticsPipes.LogisticsFluidBasicPipe, 1),
                    CraftingDependency.Basic_Liquid,
                    new Object[] {" l ", "lPl", " l ", Character.valueOf('l'), "dyeBlue", Character.valueOf('P'), pipe
                    });
