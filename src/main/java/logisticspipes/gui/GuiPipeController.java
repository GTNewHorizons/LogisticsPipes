...
public class GuiPipeController extends LogisticsBaseGuiScreen {
    ...
    protected void actionPerformed(GuiButton p_146284_1_) {
        if (p_146284_1_.id == 0) {
            MainProxy.sendPacketToServer(
                    PacketHandler.getPacket(LogicControllerPacket.class).setTilePos(pipe.container));
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if (current_Tab == 0) {
            ...
            fontRendererObj.drawString(
                    StringUtils.translate(PREFIX + "Session"),
                    sessionxCenter - fontRendererObj.getStringWidth(StringUtils.translate(PREFIX + "Session")) / 2,
                    40,
                    0x303030);
            fontRendererObj.drawString(
                    StringUtils.translate(PREFIX + "Lifetime"),
                    lifetimexCenter - fontRendererObj.getStringWidth(StringUtils.translate(PREFIX + "Lifetime")) / 2,
                    40,
                    0x303030);
            fontRendererObj.drawString(
                    StringUtils.translate(PREFIX + "Sent") + ":",
                    55 - fontRendererObj.getStringWidth(StringUtils.translate(PREFIX + "Sent") + ":"),
                    55,
                    0x303030);
            fontRendererObj.drawString(
                    StringUtils.translate(PREFIX + "Recieved") + ":",
                    55 - fontRendererObj.getStringWidth(StringUtils.translate(PREFIX + "Recieved") + ":"),
                    70,
                    0x303030);
            fontRendererObj.drawString(
                    StringUtils.translate(PREFIX + "Relayed") + ":",
                    55 - fontRendererObj.getStringWidth(StringUtils.translate(PREFIX + "Relayed") + ":"),
                    85,
                    0x303030);
            ...
            fontRendererObj.drawString(
                    StringUtils.translate(PREFIX + "RoutingTableSize") + ":",
                    110 - fontRendererObj.getStringWidth(StringUtils.translate(PREFIX + "RoutingTableSize") + ":"),
                    110,
                    0x303030);
    ...
    protected void func_146977_a(Slot slot) {
        ...
        if (TAB_SLOTS_1_2.contains(slot)
                && (current_Tab != 0 || !pipe.getOriginalUpgradeManager().hasCombinedSneakyUpgrade())) {
            return;
        }
