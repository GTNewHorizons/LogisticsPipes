...
public class GuiItemSink extends ModuleBaseGui {
    ...
    public void initGui() {
        ...
        buttonList.add(new GuiStringHandlerButton(
                0, width / 2 + 50, height / 2 - 34, 30, 20, () -> StringUtils.translate(GuiItemSink.PREFIX + (_itemSink.isDefaultRoute() ? "Yes" : "No"))));
        ...
        switch (guibutton.id) {
            ...
            case 1:
                MainProxy.sendPacketToServer(
                        PacketHandler.getPacket(ItemSinkImportPacket.class).setModulePos(_itemSink));
                break;
        }
    }
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if (fuzzyPanelSelection != -1) {
            ...
            mc.fontRenderer.drawString(
                    StringUtils.translate(GuiItemSink.PREFIX + "IgnoreData"),
                    posX + 4,
                    posY + 4,
                    !_itemSink.isIgnoreData(fuzzyPanelSelection) ? 0x404040 : 0xFF4040);
            mc.fontRenderer.drawString(
                    StringUtils.translate(GuiItemSink.PREFIX + "IgnoreNBT"),
                    posX + 4,
                    posY + 14,
                    !_itemSink.isIgnoreNBT(fuzzyPanelSelection) ? 0x404040 : 0x40FF40);
        }
    }
