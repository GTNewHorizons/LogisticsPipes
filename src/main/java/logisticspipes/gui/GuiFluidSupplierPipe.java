...
public class GuiFluidSupplierPipe extends LogisticsBaseGuiScreen {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        mc.fontRenderer.drawString(
                StringUtils.translate(GuiFluidSupplierPipe.PREFIX + "TargetInv"),
                xSize / 2 - mc.fontRenderer
                        .getStringWidth(StringUtils.translate(GuiFluidSupplierPipe.PREFIX + "TargetInv")) / 2,
                6,
                0x404040);
        mc.fontRenderer.drawString(
                StringUtils.translate(GuiFluidSupplierPipe.PREFIX + "Inventory"),
                18,
                ySize - 102,
                0x404040);
        mc.fontRenderer.drawString(
                StringUtils.translate(GuiFluidSupplierPipe.PREFIX + "Partialrequests") + ":",
                xSize - 140,
                ySize - 112,
                0x404040);
    }
    ...
    public void initGui() {
        ...
        buttonList.add(
                new GuiButton(
                        ...
                        30,
                        20,
                        logic.isRequestingPartials() ? StringUtils.translate(GuiFluidSupplierPipe.PREFIX + "Yes")
                                : StringUtils.translate(GuiFluidSupplierPipe.PREFIX + "No")));
    }
    ...
    protected void actionPerformed(GuiButton guibutton) {
        if (guibutton.id == 0) {
            ...
            ((GuiButton) buttonList.get(0)).displayString = logic.isRequestingPartials()
                    ? StringUtils.translate(GuiFluidSupplierPipe.PREFIX + "Yes")
                    : StringUtils.translate(GuiFluidSupplierPipe.PREFIX + "No");
