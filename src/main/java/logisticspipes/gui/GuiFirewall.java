...
public class GuiFirewall extends LogisticsBaseGuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.add(
                new GuiStringHandlerButton(0, width / 2 + 23, height / 2 + 27 - 139, 60, 20, () -> pipe.isBlocking() ? blocked : allowed));
        buttonList.add(
                new GuiStringHandlerButton(1, width / 2 + 23, height / 2 + 60 - 139, 60, 20, () -> pipe.isBlockProvider() ? blocked : allowed));
        buttonList.add(
                new GuiStringHandlerButton(2, width / 2 + 23, height / 2 + 93 - 139, 60, 20, () -> pipe.isBlockCrafer() ? blocked : allowed));
        buttonList.add(
                new GuiStringHandlerButton(3, width / 2 + 23, height / 2 + 126 - 139, 60, 20, () -> pipe.isBlockSorting() ? blocked : allowed));
        buttonList.add(
                new GuiStringHandlerButton(4, width / 2 + 23, height / 2 + 160 - 139, 60, 20, () -> pipe.isBlockPower() ? blocked : allowed));
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
        ...
        mc.fontRenderer.drawString(
                StringUtils.translate(GuiFirewall.PREFIX + "Filtereditemsare") + ":",
                guiLeft + 125,
                guiTop + 8,
                0x404040);
        mc.fontRenderer.drawString(
